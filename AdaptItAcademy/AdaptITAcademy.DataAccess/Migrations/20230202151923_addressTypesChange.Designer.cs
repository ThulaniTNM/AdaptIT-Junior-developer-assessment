...
namespace AdaptITAcademy.DataAccess.Migrations
{
    ...
    [Migration("20230202151923_addressTypesChange")]
    partial class addressTypesChange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdaptITAcademyAPI.Models.PhysicalAddress", b =>
                {
                    ...
                    b.Property<string>("PostalCodePhysicalAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AdaptITAcademyAPI.Models.PostalAddress", b =>
                {
                    ...
                    b.Property<string>("PostalCodePostalAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
